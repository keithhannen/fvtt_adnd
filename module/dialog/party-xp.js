export class AdndPartyXP extends FormApplication {

    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            classes: ["adnd", "dialog", "party-xp"],
            template: "systems/adnd/templates/apps/party-xp.html",
            width: 280,
            height: 400,
            resizable: false,
        });
     ...
     */
    get title() {
        return game.i18n.localize("ADND.dialog.xp.deal");
    }
     ...
     */
    getData() {
        const actors = this.object.entities.filter(e => e.data.type === "character" && e.data.flags.adnd && e.data.flags.adnd.party === true);
        let data = {
            actors: actors,
            data: this.object,
            config: CONFIG.ADND,
